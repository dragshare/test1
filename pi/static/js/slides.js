  ...
  $.widget("js.slides", {
		options: {
			...
			preload: {
				...
				image: "/static/css/images/loading.gif" // [String] Define the path to a load .gif, yes I should do something cooler
			},
    ...
    _create: function() {	
			...
			this.slidesContainer = this.element.children().not(".slidesNavigation").wrapAll( "<div id='slideContainerId' class='slidesContainer'>" ).parent().css({
			...
			this.slidesControl = this.slidesContainer.wrapInner( "<div id='slidesControlId' class='slidesControl'>" ).children().css({
				display: "none"
			});
